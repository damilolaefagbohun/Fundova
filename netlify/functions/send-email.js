  ...
  try {
    ...
    const emailBody = JSON.stringify({
      ...
      html: `<div style="font-family:sans-serif;max-width:480px;margin:0 auto;padding:32px 24px;background:#fff;border-radius:12px">
        ...
        <p style="color:#888;font-size:12px;line-height:1.6">We recommend changing your PIN after your first login. Contact us on WhatsApp <strong>08035257262</strong> or Instagram <strong>@fundova_cooperative</strong>.</p>
